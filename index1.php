             ...
             IT481 Advanced Software Development
				...
				<body lang=EN-US style='tab-interval:.5in'>
                  ...
                  <a href='logout.php'>Logout</a><br><br>
                                <table>
                                     <tr>
                                     <th>Search for Customers</th>
                                     <th>Change Customer</th>
                                     <th>Insert Customer</th>
                                    ...
                                    <form action="search.php" method="get">
                                                ...
                                                <div>
                                                   ...
                                                   Customer Profile ID: <INPUT TYPE="text" NAME=custid><br><br>
                                    ...
                                    <form action="change.php" method="POST">
                                                ...
                                                <div>
                                                   ...
                                                   Customer Name: <INPUT TYPE="text" NAME=custname><br><br>
												   Change To:<br><br>
                                                   Customer Name: <INPUT TYPE="text" NAME=chcustname><br><br>
                                ...
                                <?php      
                                           ...
                                           if($rows > 0){?> 
                                               <div><h3><?php echo "Customers contains " . count($rows) . " rows.";?></div><br>
