...
if(isset($_POST['contactname'])){
    $contactname = check_input($_POST['contactname']);
    echo "Click <a href=index>here</a> to go back";
    echo "<h4>Search results for Contact Name: $contactname</h4>";
}
...
if(isset($_POST['chordercustid'])){
    ...
    echo "<h4>Search results for Changed Order Customer ID: $chordercustid</h4>";
                                          ...
                                          try {
                                           ...
                                           if(isset($custid) || isset($custname) || isset($contactname)){
                                                $sql1 =  "INSERT INTO Customers (CustomerID,CompanyName,ContactName)
                                                VALUES ('$custid','$custname','$contactname')";
                                                $sql2 =  "SELECT * FROM Customers WHERE CompanyName = '$custname'";
                                           }

                                           if(isset($employeeid) || isset($efname) || isset($elname)){
                                                $sql1 =  "INSERT INTO Employees (EmployeesID,FirstName,LastName)
                                                VALUES ('$employeeid','$efname','$elname')";
                                                $sql2 =  "SELECT * FROM Employees WHERE EmployeeID = '$employeeid' OR LastName = '$elname'";
                                           }

                                           if(isset($orderid) || isset($ordercustid) || isset($emporderid)){
                                                $sql1 =  "INSERT INTO Orders (OrderID,CustomerID,EmployeeID)
                                                VALUES ('$orderid','$ordercustid','$emporderid')";
