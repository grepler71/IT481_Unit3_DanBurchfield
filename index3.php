				...
				<body lang=EN-US style='tab-interval:.5in'>
                  ...
                  <a href='logout.php'>Logout</a><br><br>
                                <table>
                                    ...
                                    <form action="search.php" method="get">
                                                ...
                                                <div>
                                                   ...
                                                   Customer ID: <INPUT TYPE="text" NAME=ordercustid><br><br>
                                                   Employee ID: <INPUT TYPE="text" NAME=emporderid><br><br>
                                    ...
                                    <form action="change.php" method="POST">
                                                ...
                                                <div>
												   ...
												   Change To:<br><br>
                                                   Customer ID: <INPUT TYPE="text" NAME=chordercustid><br><br>
                                ...
                                <?php      
                                           ...
                                           if($rows > 0){?> 
                                               <div><h3><?php echo "Orders contains " . count($rows) . " rows.";?></div><br>
