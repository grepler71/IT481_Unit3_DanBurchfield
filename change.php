...
if(isset($_POST['chordercustid'])){
    ...
    echo "<h4>Search results for Changed Order Customer ID: $chordercustid</h4>";
                                          ...
                                          try {
                                           ...
                                           $sql1 =  "UPDATE Customers SET CompanyName = '$chcustname' WHERE CompanyName = '$custname'";
                                           $sql2 =  "SELECT * FROM Customers WHERE CompanyName = '$chcustname'";
                                           }

                                           if((isset($employeeid) || isset($efname) || isset($elname)) && (isset($chelname))){
                                            $sql1 =  "UPDATE Employees SET LastName = '$chelname' WHERE EmployeeID = '$employeeid' OR FirstName = '$efname' OR LastName = '$elname'";
                                            $sql2 =  "SELECT * FROM Employees WHERE LastName = '$chelname'";
                                            }

                                            if((isset($orderid) || isset($ordercustid) || isset($emporderid)) && (isset($chordercustid))){
                                                $sql1 =  "UPDATE Orders SET CustomerID = '$chordercustid' WHERE OrderID = '$orderid' OR CustomerID = '$ordercustid' OR EmployeeID = '$emporderid'";
                                                $sql2 =  "SELECT * FROM Orders WHERE CustomerID = '$chordercustid'";
                                                }
